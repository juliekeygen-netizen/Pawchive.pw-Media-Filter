...
UI.closeSettings('reopen');const checked=(value)=>value?'checked':'';const selected=(value,current)=>value===current?'selected':'';const backdrop=document.createElement('div');backdrop.className='pmf-modal-backdrop';App.ui.settingsBadgeTypes=Util.clone(Settings.value.catalogueBadges.types);App.ui.settingsCreatorBadgeTypes=Util.clone(Settings.value.creatorCardBadges.types);App.ui.settingsStatusBadgeTypes=Util.clone(Settings.value.postStatusBadges.types);App.ui.settingsPreview={displayMode:App.displayMode,compactCardScale:Settings.value.compactCardScale,compactThumbnailAspectRatio:Settings.value.compactThumbnailAspectRatio,postAttachmentBadgeSize:Settings.value.postAttachmentBadgeSize,filteredPage:App.filteredPage,postStatusBadgeSize:Settings.value.postStatusBadgeSize,seenCardTreatment:Util.clone(Settings.value.seenCardTreatment),committed:false};
  ...
  GM_addStyle(`
    ...
    .pmf-popular-period{width:max-content;max-width:calc(100% - 24px);padding:8px 14px;margin:0 auto 8px;text-align:center;background:linear-gradient(180deg,#1f2326e8,#171a1de8)}
    .pmf-popular-period-title{margin-bottom:5px;color:#f1d0c0;font-size:var(--pmf-font-size-sm);font-weight:650}
    .pmf-popular-period-links{display:flex;flex-wrap:nowrap;justify-content:center;align-items:center;gap:9px}
    .pmf-popular-period-links button{appearance:none;padding:0;border:0;background:none;color:#efaaa4;font:inherit;font-size:var(--pmf-font-size-xs);white-space:nowrap;cursor:pointer}
    ...
    .pmf-popular-toolbar .pmf-status-left{display:flex;align-items:center;gap:10px;min-width:0}.pmf-popular-toolbar .pmf-status-left strong{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.pmf-popular-toolbar .pmf-status-actions{margin-left:0}
    ...
    @media(max-width:760px){
      ...
      .pmf-popular-period-links{gap:6px 10px}.pmf-popular-period-links button{font-size:var(--pmf-font-size-sm)}
